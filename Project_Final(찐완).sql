...
1. 20260128_team_project.sql 파일에 있는 DROP TABLE 모두 실행
2. 20260128_team_project.sql 파일에 있는 DROP SEQUENCE 모두 실행
3. 20260128_team_project.sql 파일에 있는 TABLE 생성 모두 실행
4. 시퀀스 모두 생성
5. 20260128_team_project.sql 파일에 있는 샘플데이터 모두 생성
6. 프로시저/함수 모두 실행(컴파일)
7. 20260128_team_project.sql 파일에 있는 샘플데이터 모두 삭제
8. 20260128_team_project.sql 파일에 있는 프로시저 데이터 입력 실행
